      ...
      <div className="mt-16 section-content min-h-screen dark:bg-midnight" id="home">
        ...
        <div className="flex flex-col md:flex-row m-10 md:m-20 lg:m-32 xl:m-60 space-y-8 md:space-x-20 md:space-y-0">
          <div className="md:w-1/2">
            <h1 className='font-bold text-7xl text-midnight'>Hello!</h1>
            <h1 className='font-bold text-7xl text-crimson'>I am AC</h1>
            <h1 className='font-bold text-6xl text-midnight'>Web and Mobile Developer</h1>
          </div>
